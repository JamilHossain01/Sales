class AppImages {
  ...
  static const String bell = "assets/images/BellSimple.png";
  ...
  static const String homeActive =
      "assets/images/home1.png"; // active home icon
  static const String homeInactive =
      "assets/images/home.png"; // inactive home icon

  static const String exploreActive = "assets/images/explore1.png";
  static const String exploreInactives =
      "assets/images/explore.png"; // inactive explore icon (rename to explore_inactive.png for clarity)
// active explore icon
  static const String exploreInactive =
      "assets/images/explores3.png"; // inactive explore icon (rename to explore_inactive.png for clarity)

  static const String servicesActive =
      "assets/images/services1.png"; // active services icon
  static const String servicesInactive =
      "assets/images/services2.png"; // inactive services icon

  static const String forumActive =
      "assets/images/forum1.png"; // active forum icon

  static const String profileActive =
      "assets/images/profiles1.png"; // active profile icon
  static const String profileInactive =
      "assets/images/profile2.png"; // inactive profile icon
  static const String messages =
      "assets/images/messages.png"; // inactive profile icon
  static const String male = "assets/images/male.png"; // inactive profile icon
  static const String peTlage =
      "assets/images/pet_leg.png"; // inactive profile icon
  static const String chips = "assets/images/chip.png"; // inactive profile icon
  static const String breed =
      "assets/images/breed.png"; // inactive profile icon
  static const String ages = "assets/images/ages.png"; // inactive profile icon
  static const String genders =
      "assets/images/genders.png"; // inactive profile icon
}
